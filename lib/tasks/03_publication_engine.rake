namespace :language_city do
  ...
  task :seed_languages => :environment do
		ActiveRecord::Base.transaction do
			ind_lang = Language.create_with(active: true).where(name: "Indian").first_or_create
			Language.create_with(parent: ind_lang, active: true).where(name: "English").first_or_create
			Language.create_with(parent: ind_lang, active: true).where(name: "Hindi").first_or_create
			Language.create_with(parent: ind_lang, active: true).where(name: "Tamil").first_or_create
			Language.create_with(parent: ind_lang, active: true).where(name: "Telugu").first_or_create
			Language.create_with(parent: ind_lang, active: true).where(name: "Kannada").first_or_create
			Language.create_with(parent: ind_lang, active: true).where(name: "Marathi").first_or_create
  ...
  task :seed_categories => :environment do
    ActiveRecord::Base.transaction do
			category = Category.create_with(active: true).where(name: "Book").first_or_create
			Category.create_with(parent: category, active: true).where(name: "Hard-Bound Book").first_or_create
			Category.create_with(parent: category, active: true).where(name: "Paperback Book").first_or_create
      Category.create_with(parent: category, active: true).where(name: "Magazine").first_or_create

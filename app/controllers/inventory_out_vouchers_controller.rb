class InventoryOutVouchersController < ApplicationController
  ...
  def index
    @inventory_out_vouchers = inventory_out_voucher_scope.includes(:created_by, :primary_location, :secondary_entity).order("number DESC")
  ...
  private
    def inventory_out_voucher_params
      params.require(:inventory_out_voucher).permit(:currency_id, :created_by_id, :remarks,

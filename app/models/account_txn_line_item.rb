class AccountTxnLineItem < ActiveRecord::Base
  belongs_to :account_txn, inverse_of: :line_items, touch: true
  belongs_to :product, inverse_of: :account_txn_line_items
  ...
  validates :quantity, presence: true, numericality: { only_integer: true, less_than_or_equal_to: 99999999 }
  ...
  validates :tax_rate, presence: true, numericality: { less_than_or_equal_to: 100 }
